          ...
          <div class="row q-col-gutter-sm">
            ...
            >
              <div
                ...
                @click="
                  $router.push(
                    '/service_providers_list/' + serviceCategory._id
                  );
                ...
                "
              >
                <!-- <q-badge class="provider-count-badge" color="orange">{{ serviceCategory.serviceProviderCount }}</q-badge> -->
                ...
                <div>
                  ...
                  <div>
                    {{ serviceCategory.serviceProviderCount }}
                  </div>
                </div>
              </div>
            </div>
            <div
              class="col-12"
              v-if="
                serviceCategoryStore.allServiceCategoryList &&
                serviceCategoryStore.allServiceCategoryList.length == 0
              "
            >
              {{ $t("noInfo") }}
            </div>
