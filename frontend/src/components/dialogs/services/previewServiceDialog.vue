          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                  {{ serviceStore.serviceInfo.description.en }}
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                 {{ serviceStore.serviceInfo.description.bn }}
                </div>
              </div>
            </div>
            <div class="col-12">
              <div class="row">
                <q-btn label="closse" color="primary" icon="arrow_back" @click="serviceStore.openServicePreviewDialog = FontFaceSetLoadEvent"/>
              </div>
            </div>
          </div>
        </q-card>
